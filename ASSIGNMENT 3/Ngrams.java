		...
		for (int n = 1; n < 5; n++) {
			...
			if( n ==1 ) {
				while (iterator_sort.hasNext()) {  
				   ...
				   System.out.println(" (\" "+two_keys[0] + " \") "+ "["+value+"];");  
				   ++topten;
				   if(topten>9) break;
				} 
			}
			...
			if( n ==2 ) {
				while (iterator_sort.hasNext()) {  
				   ...
				   System.out.println(" (\" "+two_keys[0] + " \" "+ " , "+" \" "+two_keys[1]+ " \") "+ "["+value+"];");  
				   ++topten;
				   if(topten>9) break;
				} 
			}
			...
			if( n ==3 ) {
				while (iterator_sort.hasNext()) {  
				   ...
				   System.out.println(" \" "+two_keys[0] + " \" "+ " , "+" \" "+two_keys[1]+ " \" "+" , "+" \" "+two_keys[2]+ " \") "+ "["+value+"];");  
				   ++topten;
				   if(topten>9) break;
				} 
			}
			...
			if( n ==4 ) {
				while (iterator_sort.hasNext()) {  
				   ...
				   System.out.println(" \" "+two_keys[0]+ " \" "+ " , "+" \" "+two_keys[1]+ " \" "+" , "+" \" "+two_keys[2]+ " \" "+" , "+" \" "+two_keys[3]+ " \")"+ "["+value+"];");  
				   ++topten;
				   if(topten>9) break;
				} 
			}
			...
			if( n == 2 ) {
				...
				while (iterator_sort.hasNext()) {  
				   ...
				   String value = sortedMap.get(key).toString();  
				   String[] two_keys = key.split(" ");
				   Integer weight = Integer.parseInt(value);
				   if(weight > 10) {
